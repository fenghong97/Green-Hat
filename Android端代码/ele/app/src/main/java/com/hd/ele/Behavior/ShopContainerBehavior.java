...
import com.hd.ele.R;
import com.hd.ele.View.ShopInfoContainer;
...
public class ShopContainerBehavior extends CoordinatorLayout.Behavior<ShopInfoContainer> {
    ...
    private void shouldInitProperties() {
        ...
        int statusBarHeight = com.hd.ele.Utils.ViewUtils.getStatusBarHeight(mContext);
        int acBarHeight = com.hd.ele.Utils.ViewUtils.dip2px(mContext, 56);
